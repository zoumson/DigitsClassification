...
void svmTrain(Ptr<SVM> svm, Mat &trainMat, vector<int> &trainLabels, String savedFileName)
{
...
int main(int argc, char** argv)
{
   ...
   String keys =
    ...
    String pathName = parser.get<String>("image"); 
    String savedFile = parser.get<String>("save"); 
    ...
    ///////////  SVM Training  ////////////////
    svmTrain(model, trainMat, trainLabels, savedFile);
    ///////////  SVM Testing  ////////////////
